...
Self-hosted update manager for AlexanderWagnerDev plugins. Keeps plugins up to date from a custom server — with auto-update toggles, manual re-check and one-click updates.
